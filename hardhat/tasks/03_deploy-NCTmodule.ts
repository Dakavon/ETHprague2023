...
task("deployNCTmodule", "Deploy NCT retire module").setAction(async (taskArgs, hre) => {
    ...
    const NCTRetireCollectModule = await hre.ethers.getContractFactory('NCTRetireCollectModule');
